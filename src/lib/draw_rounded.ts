...
export const draw_module_rounded = (qr, ctx: Ctx, settings: Settings, width: number, row: number, col: number) => {
    ...
    if (dark_center) {
        draw_dark(draw_ctx as Ctx, left, top, right, bottom, radius, !dark_n && !dark_w, !dark_n && !dark_e, !dark_s && !dark_e, !dark_s && !dark_w);
    } else {
        draw_light(draw_ctx as Ctx, left, top, right, bottom, radius, dark_n && dark_w && dark_nw, dark_n && dark_e && dark_ne, dark_s && dark_e && dark_se, dark_s && dark_w && dark_sw);
    }
};
